                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="w-1/3">
                        <input wire:model.live="search" type="text" placeholder="Buscar por ID, Cliente o Equipo..." 
                               class="w-full bg-gray-900/50 border-gray-700 text-gray-100 focus:border-fuchsia-500 focus:ring-fuchsia-500 rounded-md shadow-sm placeholder-gray-500">
                    </div>
                </div>
                            ...
                            @forelse ($repairs as $repair)
                                <tr class="border-b border-gray-700 hover:bg-gray-700/30 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-right text-sm flex justify-end space-x-3 items-center">
                                        ...
                                        <a href="{{ route('repairs.edit', $repair->id) }}" class="inline-block text-fuchsia-400 hover:text-fuchsia-300 transition-colors group" title="Editar">
